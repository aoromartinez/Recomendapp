...
const secretFields = ['lastfmApiKey', 'spotifyAccessToken', 'spotifyRefreshToken', 'youtubeAccessToken', 'youtubeRefreshToken'];
...
ipcMain.handle('config:get', () => { const c=readConfig(); return { lastfmUser:c.lastfmUser||'', lastfmApiKey:c.lastfmApiKey||'', spotifyClientId:c.spotifyClientId||'', spotifyConnected:!!c.spotifyRefreshToken, googleClientId:c.googleClientId||'', youtubeConnected:!!c.youtubeRefreshToken }; });
